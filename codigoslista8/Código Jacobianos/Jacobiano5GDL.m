%% Jacobiano
% EXEMPLO FEITO PARA UM MANIPULADOR DE 5 GRAUS DE LIBERDADE COM TODAS
% JUNTAS ROTACIONAIS!!
...
% syms alpha1 teta1 d1 a1 alpha2 teta2 d2 a2 alpha3 teta3 d3 a3 alpha4 teta4 d4 a4 alpha5 teta5 d5 a5
alpha1 = 90;
teta1 = 45;
d1 = 750;
a1 = 400;
...
J1 = [cross(Z0,(O5 - O0)); Z0] %Eixo Rotacional, se for Prismático Muda Para J1 = [Z0; 0]
J2 = [cross(Z1,(O5 - O1)); Z1] %Eixo Rotacional, se for Prismático Muda Para J2 = [Z1; 0]
J3 = [cross(Z2,(O5 - O2)); Z2] %Eixo Rotacional, se for Prismático Muda Para J3 = [Z2; 0]
J4 = [cross(Z3,(O5 - O3)); Z3] %Eixo Rotacional, se for Prismático Muda Para J4 = [Z3; 0]
J5 = [cross(Z4,(O5 - O4)); Z4] %Eixo Rotacional, se for Prismático Muda Para J5 = [Z4; 0]

%Matriz do Jacobiano Total (J)
J = [J1 J2 J3 J4 J5];

%Velocidade esperada do End-Effector (V)
V = J*[Vm1 Vm2 Vm3 Vm4 Vm5]'
