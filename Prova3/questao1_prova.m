...
A01 = denavit(10,540,145,-90)%teta,d,a,alfa
A02 = A01*denavit(10,0,870,180)
A03 = A02*denavit(50,0,110,-90)
A04 = A03*denavit(0,-1025,0,90)
A05 = A04*denavit(40,0,0,-90)
A06 = A05*denavit(0,-175,0,0)
